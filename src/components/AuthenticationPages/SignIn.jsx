  ...
  return (
    ...
    <div className="min-h-screen bg-[#060707] text-white font-sans flex items-center justify-center p-20 relative overflow-hidden">
      ...
      <main className="w-full max-w-3xl bg-[#131414] shadow-2xl shadow-teal-900/20 rounded-lg flex flex-col md:flex-row z-10">
        ...
        <img src="/public/img/logincard2.jfif" alt="" />
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 bg-[#1C1D1D] relative">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="email" className="block text-sm font-medium text-gray-400 mb-2">Enter your email</label>
            ...
            <div className="mb-6">
              <label htmlFor="password" className="block text-sm font-medium text-gray-400 mb-2">Enter your password</label>
              <div className="relative">
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            Dont have an account? <a className="font-semibold text-yellow-400 hover:underline" onClick={handleSignUp}>Sign Up</a>
          </p>
        </div>
      </main>
