...
function Event16() {
  ...
  const eventData = {
    eventName: "THE CODE FATHER",
    registrationFee: "₹350",
    prizeAmount: "₹4,000",
    eventDescriptionHeading: "Event Details:",
    eventDescription: "Welcome to THE CODEFATHER, where the best programmers battle for supremacy. This is your chance to showcase your skills in a high-stakes environment. From tricky algorithms to complex logic puzzles, prove you have the mind of a master coder and claim your title as The Codefather of the fest",
    guidelines: [
      "The event is open to UG and PG students only.",
      "Participation is individual.",
      "There will be three rounds in total, all to be completed within the stipulated time.",
      "Participants must be present at the venue 20 minutes before the commencement of each round.",
      "All necessary tools will be provided in the lab; no external hardware or software is permitted.",
      "Programming language: Python.",
      "The organizers reserve the right to change the rules or nature of rounds if required.",
