...
function Event26() {
  ...
  const eventData = {
    ...
    eventDescription: "This is a competition for budding entrepreneurs to pitch their innovative startup ideas. Participants will be evaluated on creativity, practicality, and presentation skills.",
    guidelines: "1. All teams will be given time for prep from 10.30am to 11.30am. After the allotted time is over, they are to submit a one-page executive summary and will be given 10min for presentation and 5min for Q&A.\n2. Eligibility: Open to all UG and PG students. Participants can compete either individually or in teams (maximum 4 members per team). One member must be designated as the team leader for communication but all members can communicate openly during presentation.\n3. Teams are expected to carry their own laptop.\n4. Participants must be in formal attire.\n5. Ideas will be evaluated based on Innovation, Creativity, Practicality, and Presentation.\n6. No vulgar, discriminatory or plagiarized content.\n7. Decision of judges will be final and binding.\n8. Teams exceeding the time limit may be penalized.\n9. Maintain professionalism and respect towards judges, organizers, and other participants.\n10. Collaborative spirit is encouraged, but copying other team ideas is strictly prohibited.",
    date: "26-09-2025",
    venue: "Room 219 (B.com S1)",
    mediaType: "video",
