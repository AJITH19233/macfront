...
function Event24() {
  ...
  const eventData = {
    eventName: "RETRO CIPHER QUEST  ",
    registrationFee: "₹350", // Registration fee is not specified in the provided text.
    prizeAmount: "₹2000",
    eventDescriptionHeading: "Event Details",
    eventDescription: "Join the Retro Cipher Quest and put your team of two to the test! This exclusive event for UG and PG computer application students will challenge your skills in three intense rounds of binary, decimal, and ASCII conversions. With an hour on the clock, can you decode your way to the final message and claim victory?",
    guidelines: "\nA team  must consist  of 2 members.  \nThe event is open to both undergraduate (UG) and postgraduate (PG) computer application students from any institution.\nAll teams  should  report  at the venue  10 minutes  before  the event  starts. \nA total  of 3 rounds  will be there, first  10 team to complete  the task advance  to 2nd round  and the next 5 teams  from the 2nd round  will advance  to the 3rd round. \nNo mobile  usage  or malpractice  allowed;  offenders  will be disqualified.\nConvert  binary  → decimal  → ASCII  → final  message. \nNo external  help  or devices  allowed.  \nTime: 1  hour.",
    date: "26/09/2025",
    venue: "216 (MCA Department)",
    mediaType: "video",
