...
function Event22() {
  ...
  const eventData = {
    ...
    eventDescription: "SHOLAY contest is designed to test the management skills of participants in various situations. Each team will face diverse challenges that will push their creativity, strategic thinking, problem-solving, and collaborative abilities to the maximum. The top-performing team will be crowned the ultimate management champions.",
    guidelines: "This is a team event, and each team should consist of 4 members from the same college.\nEntry is open for both UG and PG students. Once registration is done, further changes will not be entertained.\nThere can be any number of teams from a college.\nParticipants must be in formal attire.\nTeams are expected to carry laptops with stable network connectivity & USB drives.\nHowever, the use of laptops or any other gadgets will not be allowed unless it's a prerequisite for a specific round.\nMobile phones should be switched off and handed over to the respective volunteers before each round and can be collected back thereafter.\nDetails of each round will be given at the beginning of the respective rounds.\nParticipants are expected to report at the exact time as informed, or they will be disqualified.\nThe decisions made by the judges and the coordinators will be final. At any point, the committee has the full rights to add, modify, or delete rounds.\nAny kind of malpractices will not be entertained; if discovered, the team will be disqualified.\nClarifications, if any, have to be made prior to each round.",
    date: "26-09-2025",
    venue: "Room 202, MBA Department",
    mediaType: "video",
