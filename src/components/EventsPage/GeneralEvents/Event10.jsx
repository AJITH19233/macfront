...
function Event10() {
  ...
  const eventData = {
    eventName: "DRISHYAVUM RUCHIYUM",
    registrationFee: "₹350",
    prizeAmount: "₹3,000",
    eventDescriptionHeading: "Event Details:",
    eventDescription: "The Food Videography Challenge is a creative competition where participants bring the world of food to life through the lens. From sizzling street snacks to fine dining artistry, contestants will capture the colours, textures, and emotions of food in engaging short videos.",
    guidelines: [
      "Registration is mandatory for all participants.",
      "Each team shall be of 2 members (No individual Participation).",
      "The competition shall have one round. Rules for the round will be displayed at the venue.",
      "All undergraduate and postgraduate students with a valid identity card form their respective educational institutes are eligible to participate.",
      "Please note that Participants will have to bring their mobile phones (Digital cameras are not allowed).",
      "Any team found breaking or violating any rule would be disqualified on the spot.",
      "Participants fees is 120 /- per group.",
    ],
    date: "26/09/2025",
    venue: "Room No. 304",
    mediaType: "video",
