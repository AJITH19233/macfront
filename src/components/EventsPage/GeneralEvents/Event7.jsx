...
function Event7() {
  ...
  const eventData = {
    eventName: "CINESPIN CHALLENGE ",
    registrationFee: "₹350", // Registration fee is not specified in the provided text.
    prizeAmount: "₹3000",
    eventDescriptionHeading: "Event Details",
    eventDescription: "Step into the spotlight and test your movie knowledge in Cinespin, a thrilling event where teams of three compete for glory. Spin the wheel to receive your unique tasks and race against the clock in three intense rounds. Are you ready to prove your cinematic expertise and emerge as the champions? Join us for this high-octane event and get ready to spin your way to victory!",
    guidelines: "A team  must consist  of 3 members.  \nThe event is open to both undergraduate and postgraduate students from any institution.\nAll teams  should  report  at the venue  10 minutes  before  the event  starts. \nA total  of 3 rounds  will be there,  first 5 team to complete  the task advance  to 2nd round  and the next 3 teams  from the 2nd round  will advance  to the 3rd round. \nSpin  the wheel  with 9  tasks.  \nComplete  assigned  task  as per instructions.  \nThe decision  of the judges  will be final. \nComplete  assigned  task  as per instructions.  \nFollow fair  play  and timing  strictly.  \nTime: 40-45 mins total.",
    date: "26/09/2025",
    venue: "S1 FOOD CLASSROOM",
    mediaType: "video",
