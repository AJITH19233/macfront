...
function Event1() {
  ...
  const eventData = {
    eventName: "RETRO SNAP",
    registrationFee: "FREE ENTRY",
    prizeAmount: "₹3000",
    eventDescriptionHeading: "EVENT DETAILS",
    eventDescription: "RETRO SNAP, originally named SPOT PHOTOGRAPHY, is an exciting individual photography event. Participants are challenged to capture a single photograph that creatively embodies the 'Retro' theme.",
    guidelines: "This is an individual event; each participant competes separately.\nEntry is open for both UG and PG students. Once registered, no cancellations will be allowed.\nParticipants must bring their own camera or mobile phones with 1080p quality.\nThe theme 'Retro' must be followed for all photographs submitted.\nAll photographs must be taken within the allotted 1-hour time frame.\nRespect privacy: Avoid photographing identifiable individuals without consent.\nOnly photographs taken within the college compound are allowed.\nNo use of old or pre-clicked photographs is allowed; only fresh captures are permitted.\nBasic editing (brightness, contrast, cropping) is allowed, but heavy manipulation will lead to disqualification.\nParticipants must submit their best 1 photograph before the deadline.\nThe decision of the judges will be final and binding.\nAny kind of malpractice or plagiarism will lead to immediate disqualification.",
    date: "26-09-2025",
    venue: "Room No. 206 (BBA Dept.)",
    mediaType: "video",
