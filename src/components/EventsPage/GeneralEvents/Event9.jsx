...
function Event9() {
  ...
  const eventData = {
    eventName: "CLASSIC CLUES QUEST",
    registrationFee: "₹350", // Registration fee is not specified in the provided text.
    prizeAmount: "₹2000",
    eventDescriptionHeading: "Event Details",
    eventDescription: "Join us for the IPL Auction event, where participants will get to experience the thrill of bidding for their favorite players. This event is a test of strategy, financial planning, and quick decision-making. Are you ready to build the ultimate team and win the auction?",
    guidelines: "A team  must consist  of 2 members. \nThe event is open to both undergraduate and postgraduate students from any institution.\nAll teams  should  report  at the venue  10 minutes  before  the event  starts. \nFollow all instructions from event coordinators. \nNo use of external help, shortcuts, or unfair means. \nNo mobile  usage during rounds.\nThere are two rounds.\nAny malpractice will lead to disqualification. \nTime:  1 hour \nJudges’ decisions are final.",
    date: "26/09/2025",
    venue: "Room No. 101 (MCA Department)",
    mediaType: "video",
