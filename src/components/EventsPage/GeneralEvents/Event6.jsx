...
function Event6() {
  ...
  const eventData = {
    eventName: "SHAOLIN KICK-OFF",
    registrationFee: "₹350",
    prizeAmount: "₹4,000",
    eventDescriptionHeading: "Event Details:",
    eventDescription: "Get ready for an epic showdown! Shaolin Kickoff is an e-football tournament where the best PES players battle it out for glory. Whether you're a seasoned pro or a casual player, join us to showcase your skills, score some insane goals, and become the ultimate champion of the college fest. May the best gamer win!",
    guidelines: [
      "The event is for UG and PG Students.",
      "Participation will be Individual.",
      "There will be four rounds in total and all rounds must be completed in a stipulated time.",
      "Participants should be present at the venue 20 minutes before the commencement of the rounds.",
      "Single-elimination (knockout) format.",
      "Bring your own mobile phone and accessories.",
      "Use provided internet; personal hotspots are not allowed.",
      "Cheating leads to disqualification.",
      "Coordinators' decisions are final.",
      "Match Time: 8 minutes (full match).",
      "Team Type: Dream Team (no squad strength limit).",
